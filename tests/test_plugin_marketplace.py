...
ADD_COMMAND = "codex plugin marketplace add ManuOtel/opencode-mcp-bridge --ref v0.4.3"
...
def test_marketplace_exposes_root_plugin_via_git_url_source() -> None:
    """Root plugin uses a Git-backed root source: source=url, repo URL, ref v0.4.3."""
    entry = _plugin_entry()
    source = entry["source"]
