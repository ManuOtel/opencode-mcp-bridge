...
- Ordered fallback: free first, then paid
  `opencode-go/muse-spark-1.3-contributor` ("Muse Spark 1.3 Contributor")
  from `recommendations[1]`. Use paid only when the free model is
  unavailable and the boss explicitly approved paid for this task.
